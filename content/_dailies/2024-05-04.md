...
Check out [Espanso](https://espanso.org/) for probable applications in my daily life. I really like the {{timestamp}} feature where it outputs a timestamp based on a `trigger`. I also liked the idea of Nicole Van Der Hoeven [in this video](https://youtu.be/zoeQ5yNoXsY?t=621) about the dev log, or learning log. Basically, a set of chronological notes as you learn something. This is something I would consider for my development journey.