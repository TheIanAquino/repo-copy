...
You can link to the tag listing by referencing its name with a `tag/` prefix, like this: `[[tags/plugin]]` (results in [[../tags/plugin|tags/plugin]]).
...
The folder listings are a functionality of the [[../plugins/FolderPage|FolderPage]] plugin, the tag listings of the [[../plugins/TagPage|TagPage]] plugin. See the plugin pages for customization options.
