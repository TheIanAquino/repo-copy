...
- `locale`: used for [[./features/i18n|i18n]] and date formatting
...
If you'd like to make your own plugins, see the [[./advanced/making plugins|making custom plugins]] guide.
