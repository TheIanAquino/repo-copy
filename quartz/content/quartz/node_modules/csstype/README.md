...
- [Style types](README.md##style-types)
- [At-rule types](README.md##at-rule-types)
- [Pseudo types](README.md##pseudo-types)
- [Generics](README.md##generics)
- [Usage](README.md##usage)
- [What should I do when I get type errors?](README.md##what-should-i-do-when-i-get-type-errors)
- [Version 3.0](README.md##version-30)
...
- **New generic for time**  
  Read more on the ["Generics"](README.md.md##generics) section.
